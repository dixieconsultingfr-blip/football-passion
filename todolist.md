...
- [ ] **Google AdSense — créer un 2e bloc dédié** pour l'emplacement 300×250 sur `droits-tv-football.php` (le premier bloc, responsive 728×90, est actif depuis le 24 août 2026 — validation du site confirmée). Ne pas réutiliser le même `data-ad-slot` deux fois sur la page.
