...
- [ ] **Google AdSense — validation du site** : demande soumise le 21 août 2026 13:02, statut "Examen demandé". Délai annoncé : quelques jours à 4 semaines → **à vérifier vers le 18 septembre 2026** si pas de nouvelle avant. Une fois validé : activer les unités publicitaires dans les deux emplacements déjà réservés sur `droits-tv-football.php` (728×90 et 300×250).
